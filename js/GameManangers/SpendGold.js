    ...
    setBuyText: function() {
        game.data.buytext = new (me.Renderable.extend({
            ...
            draw: function(renderer) {
                this.font.draw(renderer.getContext(), "Press F1-F6 to Buy, Press B to Exit.  Current Gold: " + game.data.gold, this.pos.x, this.pos.y);
                this.font.draw(renderer.getContext(), "Skill 1: Increase Attack. Current Level: " + game.data.skill1 + "Cost: " + ((game.data.skill1 + 1) * 10), this.pos.x, this.pos.y + 40);
